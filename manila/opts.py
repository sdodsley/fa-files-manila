...
import manila.share.drivers.purestorage.flasharray
...
_global_opt_lists = [
    ...
    manila.share.drivers.purestorage.flasharray.flasharray_auth_opts,
    manila.share.drivers.purestorage.flasharray.flasharray_extra_opts,
    manila.share.drivers.purestorage.flasharray.flasharray_connection_opts,
